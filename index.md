...
* Peña, V. & Berger, J.O. (2017). A note on recent criticisms to Birnbaum's theorem. *soon to be available on the arXiv!.*
* Peña, V. & Berger, J.O. (2017). Constrained empirical Bayes priors on regression coefficients. *soon to be available on the arXiv!.*
